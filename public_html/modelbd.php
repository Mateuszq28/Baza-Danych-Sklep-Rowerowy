...
<h3> Przedstawiamy nasze modele! <h3>
<?php
...
echo "<td><form action=delmo.php method=POST>
...
echo "<td><form action=edmo.php method=POST>
<input type=hidden name=idos value=$idos>
...
echo "<br /><br />";
echo "<FORM action=dodmo.php method=POST>
Dodaj nowy model do bazy <br /><br />
Nazwa: <input type=text name=nazwa>
Data premiery: <input type=date name=rok>
Marka: <input type=text name=marka><br />
Rama: <input type=text name=rama>
Koła:  <input type=text name=kola>
Napęd: <input type=text name=naped>
